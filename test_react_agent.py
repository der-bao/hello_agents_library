...
from core.agent import HelloAgentsLLM
from tools.registry import ToolRegistry
from agents.react_agent import ReActAgent

from tools.built_in_tools.calculator import calculate
from tools.built_in_tools.search import search
...
def test_react_agent():
    ...
    # 显示工具使用统计
    # 实际输出为0，是因为这里统计的是Tool类的工具，而不是function工具
